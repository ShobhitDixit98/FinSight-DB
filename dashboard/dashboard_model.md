...
This table was created from the SQL view "daily_category_balance". This view calculates the total spending per category on every day up to the last refresh. See the SQL code for the view creation and a sample output in the [Views Overview Jupyter Notebook]
(https://github.com/ShobhitDixit98/FinSight-DB/blob/main/database_views/views_overview.ipynb) and/or see a description of the table below:
