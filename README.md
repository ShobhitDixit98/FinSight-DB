# Personal Finance Database and Dashboard (FinSight-DB)
...
The creation of the database was performed via the "forward engineer" feature of MySQL Workbench. Additionally, the check constraint mentioned above was added. To view the full creation script, view the [Final Database Creation Script](database_creation/final_database_creation_script.sql).
...
- Savings Transactions Processing: [savings_processing_example.ipynb](transactions_processing/savings_processing_example.ipynb)
- Checking Transactions Processing: [checking_processing_example.ipynb](transactions_processing/checking_processing_example.ipynb)
- Credit Card Transactions Processing: [cc_processing_example.ipynb](transactions_processing/cc_processing_example.ipynb)
